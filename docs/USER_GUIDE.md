...
![첫 실행 화면](screenshots/01-setup.png)
...
![잠금 해제 화면](screenshots/02-unlock.png)
...
![새 항목 추가 모달](screenshots/04-new-entry.png)
...
![패스워드 생성기](screenshots/05-generator.png)
...
![항목 상세 + TOTP](screenshots/06-entry-detail.png)
...
![변경 이력 카드](screenshots/07-version-history.png)
...
![그룹 관리 모달](screenshots/08-groups.png)
...
![건강 검진 대시보드](screenshots/09-health.png)
...
![백업/복구 모달](screenshots/10-backup.png)
...
![CSV 가져오기](screenshots/11-csv-import.png)
...
![트레이 메뉴](screenshots/12-tray.png)
...
![Quick Search 팝오버](screenshots/13-quick-search.png)
...
![설정 모달](screenshots/14-settings.png)
...
![마스터 비밀번호 변경](screenshots/15-master-change.png)
